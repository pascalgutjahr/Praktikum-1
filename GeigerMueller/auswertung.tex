...
\begin{table}[H]
  ...
  \label{tab:data}
\end{table}
Mit den Werten aus Tabelle \ref{tab:data} lässt sich die Charakteristik des Zählrohrs wie in Abbildung
...
\begin{figure}
  \centering
  \includegraphics[width=0.7\textwidth]{bilder/ladung.pdf}

\subsection{Dampfdruckkurve im Niederdruckbereich}
...
\begin{figure}[H]
  \centering
  \includegraphics[height=9cm , width=13.5cm]{fit1.pdf}
...
\end{align*}
\subsection{Dampfdruckkurve im Hochdruckbereich}
...
\begin{figure}[H] % ein großes H steht dafür, dass das Objekt auf jeden Fall den Platz hält
  \centering
  \includegraphics[height=9cm, width=13cm]{15bar.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[height=9cm, width=13cm]{Lplus.pdf}

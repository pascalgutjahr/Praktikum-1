...
charakteristischer Röntgenstrahlung zusammensetzt.
...
\begin{equation*}
  z_\su{eff}=z-\sigma
\end{equation*}
berücksichtigt. Die Abschirmkonstante $\sigma$ ist für jedes Elektron
...
Mit zunehmender Energie nimmt der Absorptionskoeffizient ab und nimmt
...
Energien werden je nach Schale, aus der das Elektron stammt, als jeweilige
...
\begin{equation}
  E_\su{n, j}=R_\su{\infty}\left(z_\su{eff,1}^2\cdot\frac{1}{n^2}
  +\alpha^2 z_\su{eff,2}^4\cdot\frac{1}{n^3}\left(\frac{1}{j+\frac{1}{2}}-
  \frac{3}{4n}\right)\right)
  \label{eqn:sommerfeld}
\end{equation}
berechnet. Hierbei ist $\alpha$ die Sommerfeldsche Feinstrukturkonstante und
...
\begin{equation}
  ...
  \label{eqn:abschirmK}
\end{equation}
berechnen. Auch hierbei ist $\alpha$ die Sommerfeldsche Feinstrukturkonstante mit
dem Wert:
\begin{equation}
  \alpha = \frac{1}{137}.
\end{equation}

...
\input{tables/CSpannung.tex} Die Erregerspannung $U$ beträgt dabei $6,72 \Volt$.
Das Verhältnis $\frac{U_\su{C}}{U}$ wird gegen $\nu$ in einem halblogarithmischen
Diagramm aufgetragen.
\begin{figure}[h]
  \centering
  \includegraphics{Bilder/UcUv.pdf}
...
nach \eqref{eqn:breit} berechnetem Theoriewert verglichen.
\begin{align*}
